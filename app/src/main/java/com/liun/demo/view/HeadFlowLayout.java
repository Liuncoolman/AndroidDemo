...
public class HeadFlowLayout extends ViewGroup {
    ...
    //在new的时候会调用此方法
    public HeadFlowLayout(Context context) {
        super(context);
        this.context = context;
    }

    public HeadFlowLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }


    public HeadFlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
...
//            Collections.reverse(lineViews);
    ...
    private void setViews() {
        ...
        for (int i = 0; i < allUrls.size(); i++) {
            //清空重新绘制
//            ImageView imageView = (ImageView) LayoutInflater.from(context).inflate(R.layout.item_group_round_avert, this, false);
//            GlideUtils.showNormalCircleImage(allUrls.get(i), imageView, R.mipmap.online_default_head);
