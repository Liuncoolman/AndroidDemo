...
//        //1、获取配置的属性值
//        TypedArray typedArray = context.getTheme().obtainStyledAttributes(attrs, R.styleable.EasySwipeMenuLayout,
//                defStyleAttr, 0);
//
//        try {
...
//                }
                ...
                if (getScrollX() < 0) {
                    ...
                    if (!mCanLeftSwipe || mRightView == null) {
                        ...
                        if (getScrollX() > mRightView.getRight() - mContentView.getRight() - mContentViewLp
                                .rightMargin) {
...
//                }
    ...
    private void handlerSwipeMenu(State result) {
        if (result == State.LEFTOPEN) {
            ...
            mViewCache = this;
            mScroller.startScroll(getScrollX(), 0, mRightView.getRight() - mContentView.getRight() - mContentViewLp
                    .rightMargin - getScrollX(), 0);
            mStateCache = result;
        } else {
